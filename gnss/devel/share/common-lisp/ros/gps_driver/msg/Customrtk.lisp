...
(cl:defmethod gpgga_read-val ((m <Customrtk>))
...
(cl:defmethod current_time-val ((m <Customrtk>))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Customrtk>) ostream)
  ...
  (cl:let* ((signed (cl:slot-value msg 'fix_quality)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 4294967296) signed)))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Customrtk>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'header) istream)
    ...
    (cl:let ((unsigned 0))
      ...
      (cl:setf (cl:slot-value msg 'fix_quality) (cl:if (cl:< unsigned 2147483648) unsigned (cl:- unsigned 4294967296))))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Customrtk>)))
  ...
  "f47566ebe55a41891d79c7671655a977")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Customrtk)))
  "Returns md5sum for a message object of type 'Customrtk"
  "f47566ebe55a41891d79c7671655a977")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Customrtk>)))
  ...
  (cl:format cl:nil "std_msgs/Header header~%float64 latitude~%float64 longitude~%float64 altitude~%float64 utm_easting~%float64 utm_northing~%uint8 zone~%string letter~%float64 hdop~%string gpgga_read~%int32 fix_quality~%time current_time~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Customrtk)))
  "Returns full string definition for message of type 'Customrtk"
  (cl:format cl:nil "std_msgs/Header header~%float64 latitude~%float64 longitude~%float64 altitude~%float64 utm_easting~%float64 utm_northing~%uint8 zone~%string letter~%float64 hdop~%string gpgga_read~%int32 fix_quality~%time current_time~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
