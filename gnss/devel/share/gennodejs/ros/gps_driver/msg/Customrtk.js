...
class Customrtk {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.int32(obj.fix_quality, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.fix_quality = _deserializer.int32(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    const resolved = new Customrtk(null);
